...
import HeaderLogo from "../../assets/black-header-logo.svg";
import mypage from "../../assets/black_mypage.svg";
import search from "../../assets/black_search.svg";
import cart from "../../assets/black_cart.svg";
import collect from "../../assets/black_collect.svg";

import '../../css/black-header.css';
                        ...
                        <div className="top-header">
                            <ul className="login-list">
                                <li className="login-item">
                                    <Link to="/" className="login-link" onClick={()=>{alert("로그아웃 되었습니다.")}}>
                                        LOGOUT
                                    </Link>
                                </li>
                                <li className="login-item">
