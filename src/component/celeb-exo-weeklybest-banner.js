...
import celeb_exo_weekly from "../data/celeb-exo-weeklybest.json";

import Modal from './modal'

const CelebExoWeeklyBanner = () => {
    ...
    return(
        <div>
            ...
            >
                ...
                {celeb_exo_weekly.celeb_exo_weekly.map(showcase =>{
                    return (
...
export default CelebExoWeeklyBanner;
